...
class WebSearcher:
    ...
    def search(self, queries: List[str], before: Optional[str] = None, after: Optional[str] = None) -> List[Source]:
        """
        ...
        filtered_results = []
        for web_page in unique_results:
            try:
            ...
            if before or after:
                ...
                if is_date_in_range(date_str, before=before, after=after):
                    filtered_results.append(web_page)
                else:
