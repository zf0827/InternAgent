...
class Idea:
    ...
    experimental_setting_list: List[str] = field(default_factory=list)
    ...
    def get_full_text(self, part: Optional[List[str]] = None) -> str:
        ...
        Returns:
            Formatted text string with selected fields
        """
        # Define all valid parts
        valid_parts = {
    ...
    def from_lists(
        ...
        experimental_setting_list: List[str],
        expected_results_list: Optional[List[str]] = None,
    ) -> "Idea":
        ...
        return cls(
            ...
            expected_results=_join_list(expected_results_list) if expected_results_list else None,
